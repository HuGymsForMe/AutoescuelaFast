...
"color: rgb(255, 255, 255);")
    ...
    def retranslateUi(self):
        ...
        self.setWindowTitle(_translate("self", "TEST 1"))
        ...
        self.opcion_22_2.setText(_translate("self", f"{self.almacen_preguntas._preguntas[self.NumeroPregunta.PREGUNTA_22]._opcion_1}"))
        self.opcion_22_1.setText(_translate("self", f"{self.almacen_preguntas._preguntas[self.NumeroPregunta.PREGUNTA_22]._opcion_2}"))
