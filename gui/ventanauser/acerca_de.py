...
class AcercaDe(QMainWindow):
    def __init__(self, ventana_user):
        ...
        self.RUTA_CSS = os.path.abspath('./css/acerca_de.css')
        self.setupUi()
